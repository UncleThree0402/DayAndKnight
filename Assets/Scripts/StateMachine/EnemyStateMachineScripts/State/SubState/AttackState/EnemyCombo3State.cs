...
{
    public class EnemyCombo3State : EnemyBaseState
    {
        public EnemyCombo3State(EnemyStateMachine enemyStateMachine, EnemyStateFactory factory) : base(enemyStateMachine, factory)
        {
        }
        ...
        public override void StartState()
        {
            ...
            _enemyStateMachine.CombatStateMachine.IsCombo3 = true;
        }
        ...
        {
            _enemyStateMachine.CombatStateMachine.IsCombo3 = false;
        }
