...
{
    public class EnemyCombo2State : EnemyBaseState
    {
        public EnemyCombo2State(EnemyStateMachine enemyStateMachine, EnemyStateFactory factory) : base(enemyStateMachine, factory)
        {
        }
        ...
        public override void StartState()
        {
            ...
            _enemyStateMachine.CombatStateMachine.IsCombo2 = true;
        }
        ...
        {
            _enemyStateMachine.CombatStateMachine.IsCombo2 = false;
        }
